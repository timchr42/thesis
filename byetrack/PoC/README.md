...
# Capabilities as a Solution against Tracking (HyTrack) —— Proof-Of-Concept

- This repository contains the code for two HyTrack apps, modified with the mitigation framework, as well as a test app to demonstrate additional functionality and the custom installer.
