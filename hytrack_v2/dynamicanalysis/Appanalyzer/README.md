...
The scala-appanalyzer is a tool for traffic collection for mobile applications for Android and AVDs (Android Emulators). It allows for plugin import to enable a wide range of functions.
...
We have a dedicated documentation on how to set up [Android](/ANDROID.md), [Android Emulator](./ANDROID_EMULATOR.md).

### Plugins

The app analyzer uses a plugin structure and available plugins can be added in the configuration in the `plugin`
