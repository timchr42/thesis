...
\title  {Capabilities as a Solution against Tracking Across Android Apps} \thiswillnotshow{give it a title}
...
\input{src/Chapters/background.tex} % Background

\input{src/Chapters/threat_model.tex} % Threat Model

\input{src/Chapters/methodology.tex} % Methodology

\input{src/Chapters/implementation.tex} % Implementation

\input{src/Chapters/evaluation.tex} % Evaluation

\input{src/Chapters/discussion.tex} % Discussion

\input{src/Chapters/related_work.tex} % Related Work

\input{src/Chapters/future_work.tex} % Future Work

\input{src/Chapters/conclusion.tex} % Conclusion

\input{src/Chapters/open_science.tex} % Open Science
