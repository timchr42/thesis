...
In this thesis, we present Byetrack --- to the best of our knowledge, the first mitigation framework that addresses these privacy issues while preserving the legitimate use cases of CTs and TWAs.
