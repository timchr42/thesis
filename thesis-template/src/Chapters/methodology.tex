...
Upon app installation, the installer extracts, error checks, encrypts and subsequently sends a policy declared by the developer in their app manifest and a config file to the browser that defines:
 \begin{itemize}
