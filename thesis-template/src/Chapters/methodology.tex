...
\textit{Ambient capabilities provide no security guarantees and serve solely as a fallback mechanism to maintain functionality in the absence of an explicit developer-defined policy.}
\end{itemize}
