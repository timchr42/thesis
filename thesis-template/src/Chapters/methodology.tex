...
\begin{enumerate}[label=H\arabic*)]
  ...
  \item Backwards compatibility with existing systems can be ensured through the use of "Ambient Capabilities"\unsure{Check concept of ACs again}.
...
\section{Components}
In summary, the proposed solution requires the framework to change or add the following components:
\begin{itemize}
  \item \textbf{Manifest or config file} for the developers to define which origins should retain shared browser state. 
