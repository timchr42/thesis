...
\paragraph{Main Goal.} The main research goal is to prevent HyTrack's cross-app tracking attack \cite{USENIX:Wessels:2025} by addressing the underlying weaknesses of CustomTabs (CTs) and TrustedWebActivities(TWAs) identified in \autoref{sec:hytrack-weaknesses}, while adhering to the design goals defined by Wessels et al. in \autoref{sec:hytrack-goals}.
...
\paragraph{Types.}
We distinguish between \texttt{Wildcard} and \texttt{Final} capability tokens.
