...
During app installation, the installer extracts and transmits the policy to the browser.
 According to this policy, the browser creates wildcard capability tokens for the app wrapping important metadata into a secure structure, encoded, signed and encrypted, similar to JSON Web Tokens (JWT)~\cite{rfc7519}.
