...
\begin{itemize}
  \item \textbf{Wildcard Capabilities:} Allow the webserver to define arbitrary cookie names and values, which are "filled in" at runtime.
    These capabilities allow conversion of regular cookies into cookie capabilities, hence each authorized app receives such a capability.
