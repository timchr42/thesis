...
Finally, future work may examine the usability and performance trade-offs of capability enforcement, developer adoption barriers, and possible integration with emerging web privacy standards such as CHIPS or Storage Partitioning.
...
% (1): make the mitigation unspoofable by an cooperating tracking library (Intent Problem)
% (2): For simplicity, cookies sent back to app only entail the cookie name and value, no further enformation such es expiration data etc.
