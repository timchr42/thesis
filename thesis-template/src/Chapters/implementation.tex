...
\begin{enumerate}
  \item \textbf{StoreNormally:}
    If the cookie is permitted for global storage (via a predefined or wildcard global token), Byetrack allows the native Gecko insertion flow (\texttt{storage$\rightarrow$AddCookie()}) to proceed.
