...
We implement a \texttt{ApplyByetrackFromLoadStateToBrowserContext} function that transfers our tokens from the \texttt{DocShellLoadState} into the active top level browsing context, where they become accessible thoughout the browsing sessions lifecycle.
...
Using mozillas JSON writer utility, the function iterates over the map entries, associating each domain with an array of token strings.
