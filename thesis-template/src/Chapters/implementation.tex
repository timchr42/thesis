...
Note that the cookie name parameter is set to "*" for wildcard tokens to indicate that they apply to all cookies for the given domain and that the rights parameter is set to "NONE" for all wildcard tokens.
...
Here, we again leverage the top-level browsing context to retrieve wildcard capability tokens and pass them as an additional parameter.
