...
In addition, the token's access rights are updated to m\texttt{READ\_WRITE}, making the cookie name and value accessible to the application by the additional utility Byetrack provides (\autoref{sec:utility}).
