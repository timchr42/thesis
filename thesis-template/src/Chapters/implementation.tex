...
TODO: retrieve uid from intent problem: pendingIntent, encryption, shared key, ipc connection only with session (TWAs); Working schemes: Commitment Scheme (Eric Sven), wrap in pending intent and let browser launch TWA/CT, Change android source code to add extra to intent so uid can easily be retrieved.
