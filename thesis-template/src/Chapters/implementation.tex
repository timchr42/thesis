...
\textbf{Predefined Section:} The predefined section specifies explicit capability bindings between domains ad the cookies that are allowed to be associated with them.
