...
Before presenting the design and implementation of our mitigation, we first provide the necessary background on tracking (\autoref{sec:tracking-web-mobile}), Android's web content integration mechanisms (\autoref{sec:customtabs-twas}), and the HyTrack attack (\autoref{sec:hytrack}).
...
However, as later discussed in \autoref{sec:hytrack}, this same feature also introduces significant privacy risks.
