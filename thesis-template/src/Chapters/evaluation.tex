...
We first describe the experimental setup, before detailing the results that we oberved and finally summarizing our findings.
...
\section{Results}
Our results focus on three main aspects: the mitigation of the HyTrack attack, verification of the design goals postulated by the authors of HyTrack, and highlighting the additional behaviours our mitigation provides.
...
%\subsection{Elimination of CT/TWA Weaknesses} Move to Background "Our Approach"
%\begin{itemize}
