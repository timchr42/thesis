...
We first describe the experimental setup (\autoref{sec:eval-setup}), before detailing (\autoref{sec:eval-results}) and interpreting the results that we observed (\autoref{sec:interpret-results}).
