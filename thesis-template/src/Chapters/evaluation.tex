...
In doing so, I aim to demonstrate that the solution effectively blocks HyTrack's cross-app tracking channel while maintaining compatibility and usability.\unsure{optimally yes, but possible in practice?}
