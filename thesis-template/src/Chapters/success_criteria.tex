...
\begin{itemize}
  ...
  \item It must adhere to the three primary goals outlined by HyTrack: (1) support all features of the Web platform, (2) do not break the seamless integration, and (3) make shared state available to the Custom Tab or Trusted Web Activity.
