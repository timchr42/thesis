...
\begin{itemize}
  ...
  \item The thesis must provide a thorough discussion of how capability-based access control contributes to mitigating the identified tracking risks, including analysis of potential trade-offs (e.g., small form of ambient authority as based on identity).
\end{itemize}
