...
HyTrack \cite{USENIX:Wessels:2025} demonstrates a novel cross-app and cross-web tracking technique in the Android ecosystem by exploiting the shared cookie storage between CTs and TWAs.
...
The need to address HyTrack becomes even more critical in light of additional research.
...
We extend this idea by including the cookie information and other metadata in the token's payload, and by establishing a communication channel between the browser and the app: % -> cont. next line
