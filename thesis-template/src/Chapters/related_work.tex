...
In contrast to prior discussed mitigation strategies like \dots \change{cont. here},this approach provides developers with a practical and enforceable way to render cross-app tracking infeasible while adhering to the goals stated by the HyTrack authors.
