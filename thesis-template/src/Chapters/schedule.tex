...
In case I encounter problems in adapting the Installer to send the policy to the browser, I will explore sending the policy on each app launch via a modified Zygote instead.
