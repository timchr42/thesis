...
\item \textbf{Week 1:} \textit{Background Research and Literature Review} \par
  ...
  \item \textbf{Weeks 2-4:} \textit{Implementation} \par
    Identify which components of Chromium and App need to be modified.
...
In the worst case, the capability-based approach may prove ineffective at preventing cross-app tracking in practice, and indeed a complete redesign of the Custom Tab and Trusted Web Activity API is needed, as suggested by the authors of HyTrack.
...
At much lower impact, the implementation may not be feasible within the given timeframe or due to unforeseen technical challenges.
In this case, development will focus on a minimally viable proof-of-concept that demonstrates core functionality and missing features will be discussed as future work.
